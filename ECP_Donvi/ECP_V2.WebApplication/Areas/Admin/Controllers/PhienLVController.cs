...
namespace ECP_V2.WebApplication.Areas.Admin.Controllers
{
    ...
    public class PhienLVController : UTController
    {
        ...
        public ActionResult List(int page, int pageSize, string filter, int tcphien, int catdien, int tiepdia,
            int khac, string DateFrom, string DateTo, string DonViId, string PhongBanId, int ttPhien, int? chuyenNPC, string LoaiBieuDo = "DS")
        {
            ...
            if (DonViId == null)
            {
                model = _plviec_ser.AdvancedSearchPhienLv(page1, pagelength1, filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, Duyet, chuyenNPC ?? -1, "").ToList();
                Count = _plviec_ser.CountTotalPhienLV(filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, Duyet, chuyenNPC ?? -1, "");
            }
            else
            {
                if (string.IsNullOrEmpty(DonViId))
                ...
                else
                {
                    ...
                    if (donVi != null)
                    {
                        if (((donviId.Length == 4 && donVi.DviCha.Equals("PA")) || donviId.ToUpper().Equals("PH") || donviId.ToUpper().Equals("PN") || donviId.ToUpper().Equals("PM")) && (User.IsInRole("Master") || User.IsInRole("Manager")))
                        {
                            if (Duyet == 0)
                            {
                                model = _plviec_ser.AdvancedSearchPhienLv(page1, pagelength1, filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, (int)TrangThaiPhienLV.DaDuyet, chuyenNPC ?? -1, "").ToList();
                                List<PhienLVModel> modelDaXong = _plviec_ser.AdvancedSearchPhienLv(page1, pagelength1, filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, (int)TrangThaiPhienLV.DaXong, chuyenNPC ?? -1, "").ToList();
                                List<PhienLVModel> modelHuyBo = _plviec_ser.AdvancedSearchPhienLv(page1, pagelength1, filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, (int)TrangThaiPhienLV.HuyBo, chuyenNPC ?? -1, "").ToList();

                                Count = _plviec_ser.CountTotalPhienLV(filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, (int)TrangThaiPhienLV.DaDuyet, chuyenNPC ?? -1, "");
                                int CountDaXong = _plviec_ser.CountTotalPhienLV(filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, (int)TrangThaiPhienLV.DaXong, chuyenNPC ?? -1, "");
                                int CountHuyBo = _plviec_ser.CountTotalPhienLV(filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, (int)TrangThaiPhienLV.HuyBo, chuyenNPC ?? -1, "");
                        ...
                        else
                        {
                            if (User.IsInRole("Leader"))
                            {
                                ...
                                model = _plviec_ser.AdvancedSearchPhienLv(page1, pagelength1, filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, phongBanID, Duyet, chuyenNPC ?? -1, "leader").ToList();
                                Count = _plviec_ser.CountTotalPhienLV(filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, phongBanID, Duyet, chuyenNPC ?? -1, "leader");
                            }
                            else
                            {
                                model = _plviec_ser.AdvancedSearchPhienLv(page1, pagelength1, filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, Duyet, chuyenNPC ?? -1, "").ToList();
                    ...
                    if (idPhieuCongTac > 0)
                    {
                        ...
                        if (nv != null)
                        {
                            ...
                            try
                            {
                                ...
                                nhatKy.TrangThaiCu = trangThaiCu;
                                nhatKy.TrangThaiMoi = plv.TrangThai;
                                nhatKy.GhiChu = phieuLenh + " Chuyền hoàn";
                                nhatKy.PhongBanId = plv.PhongBanID;
        ...
        public ActionResult ListPhieuCongTac(int page, int pageSize, string filter, int tcphien, int catdien, int tiepdia, int khac, string DateFrom, string DateTo, string DonViId, string PhongBanId, int ttPhien, string loaiCV, int? chuyenNPC, int loaiPhieuLenh = 0)
        {
            ...
            if (DonViId != null)
            {
                if (string.IsNullOrEmpty(DonViId))
                {
                    model = _plviec_ser.AdvancedSearchPhieuCongTac(page1, pagelength1, filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, Duyet, chuyenNPC ?? -1, "", loaiCV).ToList();
                    Count = _plviec_ser.CountTotalPhieuCongTac(filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, Duyet, chuyenNPC ?? -1, "", loaiCV);
                }
                else
                {
                    var donVi = _dvi_ser.GetById(donviId);
                    ...
                    if (donVi != null)
                    {
                        if (((donviId.Length == 4 && donVi.DviCha.Equals("PA")) || donviId.ToUpper().Equals("PH") || donviId.ToUpper().Equals("PN") || donviId.ToUpper().Equals("PM")) && (User.IsInRole("Master") || User.IsInRole("Manager")))
                        {
                            if (Duyet == 0)
                            {
                                model = _plviec_ser.AdvancedSearchPhieuCongTac(page1, pagelength1, filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, (int)TrangThaiPhienLV.DaDuyet, chuyenNPC ?? -1, "", loaiCV).ToList();
                                List<PhienLVModel> modelDaXong = _plviec_ser.AdvancedSearchPhieuCongTac(page1, pagelength1, filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, (int)TrangThaiPhienLV.DaXong, chuyenNPC ?? -1, "", loaiCV).ToList();
                                List<PhienLVModel> modelHuyBo = _plviec_ser.AdvancedSearchPhieuCongTac(page1, pagelength1, filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, (int)TrangThaiPhienLV.HuyBo, chuyenNPC ?? -1, "", loaiCV).ToList();

                                Count = _plviec_ser.CountTotalPhieuCongTac(filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, (int)TrangThaiPhienLV.DaDuyet, chuyenNPC ?? -1, "", loaiCV);
                                int CountDaXong = _plviec_ser.CountTotalPhieuCongTac(filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, (int)TrangThaiPhienLV.DaXong, chuyenNPC ?? -1, "", loaiCV);
                                int CountHuyBo = _plviec_ser.CountTotalPhieuCongTac(filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, (int)TrangThaiPhienLV.HuyBo, chuyenNPC ?? -1, "", loaiCV);
                        ...
                        else
                        {
                            if (User.IsInRole("Leader"))
                            {
                                ...
                                model = _plviec_ser.AdvancedSearchPhieuCongTac(page1, pagelength1, filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, phongBanID, Duyet, chuyenNPC ?? -1, "leader", loaiCV).ToList();
                                Count = _plviec_ser.CountTotalPhieuCongTac(filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, phongBanID, Duyet, chuyenNPC ?? -1, "leader", loaiCV);
                            }
                            else
                            {
                                model = _plviec_ser.AdvancedSearchPhieuCongTac(page1, pagelength1, filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, Duyet, chuyenNPC ?? -1, "", loaiCV).ToList();
            ...
            {
                var objPCTHT = _SoPhieuHienTai_ser.GetObjByDonVi(System.Configuration.ConfigurationManager.ConnectionStrings["IdentityDbContext"].ConnectionString,
                ...
                var objLCTHT = _SoPhieuHienTai_ser.GetObjByDonVi(System.Configuration.ConfigurationManager.ConnectionStrings["IdentityDbContext"].ConnectionString,
        ...
        [HttpGet]
        public ActionResult ListLenhCongTac(int page, int pageSize, string filter, int tcphien, int catdien, int tiepdia, int khac, string DateFrom, string DateTo, string DonViId, string PhongBanId, int ttPhien, int chuyenNPC)
        {
            filter = filter.Trim().ToUpper();
            int page1 = (page - 1) * pageSize;
            int pagelength1 = page * pageSize;
            ...
            if (DonViId != null)
            {
                if (string.IsNullOrEmpty(DonViId))
                {
                    model = _plviec_ser.AdvancedSearchPhienLv(page1, pagelength1, filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, Duyet, chuyenNPC, "").ToList();
                    Count = _plviec_ser.CountTotalPhienLV(filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, Duyet, chuyenNPC, "");
                }
                else
                {
                    var donVi = _dvi_ser.GetById(donviId);
                    ...
                    if (donVi != null)
                    {
                        if (((donviId.Length == 4 && donVi.DviCha.Equals("PA")) || donviId.ToUpper().Equals("PH") || donviId.ToUpper().Equals("PN") || donviId.ToUpper().Equals("PM")) && (User.IsInRole("Master") || User.IsInRole("Manager")))
                        {
                            if (Duyet == 0)
                            {
                                model = _plviec_ser.AdvancedSearchPhienLv(page1, pagelength1, filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, (int)TrangThaiPhienLV.DaDuyet, chuyenNPC, "").ToList();
                                List<PhienLVModel> modelDaXong = _plviec_ser.AdvancedSearchPhienLv(page1, pagelength1, filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, (int)TrangThaiPhienLV.DaXong, chuyenNPC, "").ToList();
                                List<PhienLVModel> modelHuyBo = _plviec_ser.AdvancedSearchPhienLv(page1, pagelength1, filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, (int)TrangThaiPhienLV.HuyBo, chuyenNPC, "").ToList();

                                Count = _plviec_ser.CountTotalPhienLV(filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, (int)TrangThaiPhienLV.DaDuyet, chuyenNPC, "");
                                int CountDaXong = _plviec_ser.CountTotalPhienLV(filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, (int)TrangThaiPhienLV.DaXong, chuyenNPC, "");
                                int CountHuyBo = _plviec_ser.CountTotalPhienLV(filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, (int)TrangThaiPhienLV.HuyBo, chuyenNPC, "");
                        ...
                        else
                        {
                            if (User.IsInRole("Leader"))
                            {
                                ...
                                model = _plviec_ser.AdvancedSearchPhienLv(page1, pagelength1, filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, phongBanID, Duyet, chuyenNPC, "leader").ToList();
                                Count = _plviec_ser.CountTotalPhienLV(filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, phongBanID, Duyet, chuyenNPC, "leader");
                            }
                            else
                            {
                                model = _plviec_ser.AdvancedSearchPhienLv(page1, pagelength1, filter, tcphien, catdien, tiepdia, khac, DateFrom, DateTo, DonViId, PhongBanId, Duyet, chuyenNPC, "").ToList();
        ...
        public async Task<ActionResult> LuuNhayPhieu(int SoLuong, int MaLP, int? TramId)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < SoLuong; i++)
                {
                    ...
                    var dtSP = _SoPhieuHienTai_ser.GetObjByDonVi(System.Configuration.ConfigurationManager.ConnectionStrings["IdentityDbContext"].ConnectionString,
                            Session["DonViID"].ToString(), MaLP.ToString(), TramId.ToString());
                    if (dtSP != null)
                    {
                        dtSP.NgayTao = DateTime.Now;
                        dtSP.NguoiTao = User.Identity.Name;
                        dtSP.SoPhieu = sophieumoi;
                        dtSP.IsHand = true;
                        dtSP.MaPCT = null;
                        dtSP.Nam = now.Year;
                        dtSP.Thang = now.Month;
        ...
        public ActionResult CmbSoPhieuCongTac(int MaLP, int PhieuID)
        {
            try
            {
                ...
                string html = "";
                var dtSP = _lsCapSoPhieu_ser.GetListSearch(System.Configuration.ConfigurationManager.ConnectionStrings["IdentityDbContext"].ConnectionString,
                            Session["DonViID"].ToString(), MaLP.ToString(), objPCT.TramId.ToString());
                var lstTram = tramRepository.ListByPhongBanId(Session["PhongBanId"].ToString(), strcon).ToList();
                foreach (var item in dtSP)
                {
                    if (item.TramId != null)
                    {
                        ...
                        if (objt != null)
                            html += "<option value=" + item.ID + ">" + item.SoPhieu.Trim() + " - " + objt.Ten + "</option>";
                        else
        ...
        public ActionResult CmbSoPhieuHienTaiTheoTram(int MaLP)
        {
            try
            {
                ...
                foreach (var item in lstTram)
                {
                    string SoPhieu = "";
                    var objPCTHT = _SoPhieuHienTai_ser.GetObjByDonVi(System.Configuration.ConfigurationManager.ConnectionStrings["IdentityDbContext"].ConnectionString,
                                            Session["DonViID"].ToString(), MaLP.ToString(), item.Id.ToString());
                    if (objPCTHT != null)
                    {
                        SoPhieu = objPCTHT.SoPhieu;
                        html += "<option value=" + item.Id + ">" + item.Ten.Trim() + " - " + SoPhieu + "</option>";
                    }
                    else
                        html += "<option value=" + item.Id + ">" + item.Ten.Trim() + "</option>";
                }
        ...
        public bool UpdateSoPhieuMoiNhat(plv_PhieuCongTac obj)
        {
            ...
            try
            {
                List<plv_PhieuCongTac> lstP = _pcongtac_ser.GetObjPhieu(System.Configuration.ConfigurationManager.ConnectionStrings["IdentityDbContext"].ConnectionString
                    , Session["DonViID"].ToString(), obj.MaLP.ToString(), obj.TramId.ToString());
                ...
                foreach (var item in lstP)
                {
                    try
                    {
                        ...
                        objM.Ngay = new DateTime(2000 + int.Parse(objM.SoPhieu.Split('/')[2]), int.Parse(objM.SoPhieu.Split('/')[1]), 1);
                ...
                var lstdata = lstD.Where(o => o.Ngay.Month == objF.Ngay.Month && o.Ngay.Year == objF.Ngay.Year);
                ...
                if (dtSP != null)
                {
                    dtSP.NgayTao = DateTime.Now;
                    dtSP.NguoiTao = User.Identity.Name;
                    dtSP.SoPhieu = objOK.SoPhieu;
                    dtSP.MaPCT = objOK.ID;
                    dtSP.Thang = DateTime.Now.Month;
                    dtSP.Nam = DateTime.Now.Year;
                    _SoPhieuHienTai_ser.Update(dtSP, ref errls);
                }
                else
                {
