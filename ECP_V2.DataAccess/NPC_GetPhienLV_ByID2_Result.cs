...
public partial class NPC_GetPhienLV_ByID2_Result
{
    ...
    public Nullable<long> RowNum20 { get; set; }

    public string HoTenNguoiTao { get; set; }

    public string HoTenNguoiDuyet { get; set; }

    public string HoTenNguoiDuyetNPC { get; set; }
    ...
    public Nullable<System.DateTime> NgayDuyetPhieu { get; set; }

    public Nullable<System.DateTime> NgayCapSo { get; set; }

    public string NguoiCapSo { get; set; }
