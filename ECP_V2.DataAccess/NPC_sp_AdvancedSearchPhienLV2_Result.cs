...
public partial class NPC_sp_AdvancedSearchPhienLV2_Result
{
    ...
    public Nullable<int> SoLanSua { get; set; }
    ...
    public Nullable<int> SoComment { get; set; }

    public Nullable<System.DateTime> NgayTao { get; set; }

    public Nullable<int> SoAnhXoa { get; set; }
