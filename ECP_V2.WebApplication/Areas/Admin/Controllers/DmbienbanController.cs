...
{
    public class DmbienbanController : Controller
    {
        ...
        public JsonResult GetListDmBienban()
        {
            List<Danhmuc> lstFields = dmRepository.GetDmBienban("0");
        ...
        public ActionResult OnSave()
        {
            try
            {
                ...
                //1. Insert exam nhé
                string examid = dmRepository.InsertDmuc(madmuc, tendmuc, trangthai, loai, "DMBB");
        ...
        public ActionResult OnDelete()
        {
            try
            {
                ...
                //1. Insert exam nhé
                string examid = dmRepository.DeleteDmuc(madmuc,"DMBB");
