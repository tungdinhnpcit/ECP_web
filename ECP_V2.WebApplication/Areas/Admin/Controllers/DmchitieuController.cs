...
{
    public class DmchitieuController : Controller
    {
        ...
        public JsonResult GetListDmChitieu()
        {
            List<Danhmuc> lstFields = dmRepository.GetDmBienban("8");
        ...
        public ActionResult OnSave()
        {
            try
            {
                ...
                //1. Insert exam nhé
                string examid = dmRepository.InsertDmuc(madmuc, tendmuc, trangthai, loai, "DMCTIEU");
        ...
        public ActionResult OnDelete()
        {
            try
            {
                ...
                //1. Insert exam nhé
                string examid = dmRepository.DeleteDmuc(madmuc, "DMCTIEU");
