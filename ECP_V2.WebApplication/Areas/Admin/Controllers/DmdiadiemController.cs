...
{
    public class DmdiadiemController : Controller
    {
        ...
        public JsonResult GetListDmDiadiem()
        {
            List<Danhmuc> lstFields = dmRepository.GetDmBienban("1");
        ...
        public ActionResult OnSave()
        {
            try
            {
                ...
                //1. Insert exam nhé
                string examid = dmRepository.InsertDmuc(madmuc, tendmuc, trangthai, loai, "DMDD");
        ...
        public ActionResult OnDelete()
        {
            try
            {
                ...
                //1. Insert exam nhé
                string examid = dmRepository.DeleteDmuc(madmuc, "DMDD");
