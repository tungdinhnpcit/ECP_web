...
{
    public class DmdinhkyController : Controller
    {
        ...
        public JsonResult GetListDmDinhky()
        {
            List<Danhmuc> lstFields = dmRepository.GetDmBienban("2");
        ...
        public ActionResult OnSave()
        {
            try
            {
                ...
                //1. Insert exam nhé
                string examid = dmRepository.InsertDmuc(madmuc, tendmuc, trangthai, loai, "DMDK");
        ...
        public ActionResult OnDelete()
        {
            try
            {
                ...
                //1. Insert exam nhé
                string examid = dmRepository.DeleteDmuc(madmuc, "DMDK");
