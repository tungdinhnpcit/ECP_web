...
{
    public class DmloaidtsucoController : Controller
    {
        ...
        public JsonResult GetListDmLoaiDtsuco()
        {
            List<Danhmuc> lstFields = dmRepository.GetDmBienban("9");
        ...
        public ActionResult OnSave()
        {
            try
            {
                ...
                //1. Insert exam nhé
                string examid = dmRepository.InsertDmuc(madmuc, tendmuc, trangthai, loai, "DMDTSUCO");
        ...
        public ActionResult OnDelete()
        {
            try
            {
                ...
                //1. Insert exam nhé
                string examid = dmRepository.DeleteDmuc(madmuc, "DMDTSUCO");
