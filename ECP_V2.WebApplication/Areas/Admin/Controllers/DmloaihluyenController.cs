...
{
    public class DmloaihluyenController : Controller
    {
        ...
        public JsonResult GetListDmLoaiHL()
        {
            List<Danhmuc> lstFields = dmRepository.GetDmBienban("6");
        ...
        public ActionResult OnSave()
        {
            try
            {
                ...
                //1. Insert exam nhé
                string examid = dmRepository.InsertDmuc(madmuc, tendmuc, trangthai, loai, "DMLHL");
        ...
        public ActionResult OnDelete()
        {
            try
            {
                ...
                //1. Insert exam nhé
                string examid = dmRepository.DeleteDmuc(madmuc, "DMLHL");
