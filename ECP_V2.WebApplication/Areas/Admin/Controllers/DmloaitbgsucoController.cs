...
{
    public class DmloaitbgsucoController : Controller
    {
        ...
        public JsonResult GetListDmLoaiTBGsuco()
        {
            List<Danhmuc> lstFields = dmRepository.GetDmBienban("10");
        ...
        public ActionResult OnSave()
        {
            try
            {
                ...
                //1. Insert exam nhé
                string examid = dmRepository.InsertDmuc(madmuc, tendmuc, trangthai, loai, "DMTBSCO");
        ...
        public ActionResult OnDelete()
        {
            try
            {
                ...
                //1. Insert exam nhé
                string examid = dmRepository.DeleteDmuc(madmuc, "DMTBSCO");
