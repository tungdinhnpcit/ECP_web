...
{
    [Authorize]
    public class pccc_LoaiThietBiController : Controller
    {
        ...
        // GET: Admin/CCDC
        [HasCredential(MenuCode = "PCCC_LoaiTB")]
        ...
        public ActionResult Create(int? MaNhom)
        {
            try
            {
                ...
                pccc_LoaiThietBiViewModels Model = new pccc_LoaiThietBiViewModels();
        ...
        [HttpPost]
        public ActionResult Create(pccc_LoaiThietBiViewModels model)
        {
            string kt = "|";
            CreateDropHangSX(null);
            CreateDropNuocSX(null);
            ...
            try
            {
                ...
                pccc_LoaiThietBi obj = new pccc_LoaiThietBi();
            ...
            {
                kt = "|" + ex.Message;
                NLoger.Error("loggerDatabase", string.Format("Lỗi tạo thiết bị phòng cháy chữa cháy. Chi tiết: {0}", ex.Message));
            }
            DisposeAll();
            ...
            string DonViId, string PhongBanId, string MaNhom)
        {
            ...
            List<pccc_LoaiThietBiModel> model;
            ...
            var ListNewsPageSize = new PageData<pccc_LoaiThietBiModel>();
            if (model.Count() > 0)
            {
                ListNewsPageSize.Data = model;
                ListNewsPageSize.Page = new Page()
                {
                    RecordsName = "Loại thiết bị phòng cháy chữa cháy",
            ...
            {
                ListNewsPageSize.Data = new List<pccc_LoaiThietBiModel>();
                ListNewsPageSize.Page = new Page()
                {
                    RecordsName = "Loại thiết bị phòng cháy chữa cháy",
                    NumberOfPages = 0,
        ...
        {
            pccc_LoaiThietBiViewModels Model = null;
            try
            {
                ...
                Model = new pccc_LoaiThietBiViewModels();
                Model.ID = obj.ID;
        ...
        public ActionResult Edit(pccc_LoaiThietBiViewModels model)
        {
            string kt = "|";
            try
            {
