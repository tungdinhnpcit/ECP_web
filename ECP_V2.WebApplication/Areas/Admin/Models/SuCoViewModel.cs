...
namespace ECP_V2.WebApplication.Areas.Admin.Models
{
    public class SuCoViewModel
    {
        ...
        public string MaTBSco { get; set; }
        public string TenTBSco { get; set; }
        public string MaTBTdong { get; set; }
        public string TenTBTdong { get; set; }
        ...
        public Nullable<int> HanhLangId { get; set; }
        public Nullable<int> ThienTaiId { get; set; }
        ...
        public bool IsMcDnguon { get; set; }
