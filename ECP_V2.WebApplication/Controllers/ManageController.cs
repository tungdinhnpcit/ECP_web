    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model, string returnUrl)
        {
            ...
            if (result.Succeeded)
            {
                ...
                {
                    tblDonVi donVi = donViRepository.GetById(Session["DonViID"].ToString());
        ...
        private ActionResult RedirectToLocal(string returnUrl, ApplicationUser user)
        {
            ...
            else
            {
                ...
                //}
                //if (UserManager.IsInRole(user.Id, "DuyetViec"))
                //{
                //    return RedirectToAction("Index", "Home", new { area = "DuyetViec" });
                //}
