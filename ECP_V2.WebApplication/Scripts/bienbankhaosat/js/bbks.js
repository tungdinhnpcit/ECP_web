var bbks = {
    ...
    load: function () {
        ...
        $('#tbldanhmuc tbody').on('click', 'a', function () {
            ...
            else if ($(this).hasClass('viewViTri')) {
                console.log("add vitri action: ", data);
                $('#id_bbks').val(data.ID);
                model_bbks.parrent = this;
                model_bbks.view_vitri();
            }
        ...
        "columns": [
            ...
            //{ "data": "NGAY_DUYET ", "width": "10%" },
            {
                "data": null, render: function (data, type, row) {
                    ...
                    html = html + '<a title="Thêm vị trí vào biên bản" class="addViTri method"><img src="/Images/ImageDesign/xacnhan_icon.png" style="width=17px;height:17px" alt="edit"></a><br/>';
                    html = html + '<a title="Xem vị trí đã thêm vào biên bản" class="viewViTri method"><img src="/Images/ImageDesign/street-view-solid.png" style="width=17px;height:17px" alt="view"></a>';
                    return html;
                }, "width": "10%"
            },
        ],
